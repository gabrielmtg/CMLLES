#ifndef CNN_SIMPLE_PARAMS_H
#define CNN_SIMPLE_PARAMS_H
...
static const int32_t CONV_MULTIPLIERS[] = {3310, 6097, 4806};
static const int CONV_SHIFTS[] = {-20, -20, -20};
#define FC_MULTIPLIER 3346
#define FC_SHIFT -20
...
static const LayerInfo LAYER_INFO[] = {
    {0, 3, 16, 3, 2, 1, 32, 32, 16, 16},
    {0, 16, 32, 3, 2, 1, 16, 16, 8, 8},
    {0, 32, 64, 3, 2, 1, 8, 8, 4, 4},
};
