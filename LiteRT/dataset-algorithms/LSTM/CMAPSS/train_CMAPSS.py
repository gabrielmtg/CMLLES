...
if __name__ == "__main__":
    ...
    epochs_no_impro = 0
    best_state      = None
    print(f"\nTreinando por até {EPOCHS} épocas (early stopping = {PATIENCE})...\n")
