...
def main():
    ...
    print("=" * 50)
    print("  Iris MLP — Treinamento PyTorch -> LiteRT (.tflite)")
    print("=" * 50)
    ...
    print("\nConvertendo modelo para LiteRT...")
    edge_model = litert_torch.convert(model, (dummy,)) 
    edge_model.export(MODEL_TFLITE)
    
    print(f"Sucesso! Modelo exportado como: {MODEL_TFLITE}")
