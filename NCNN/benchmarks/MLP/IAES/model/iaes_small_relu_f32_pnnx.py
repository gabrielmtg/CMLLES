...
class Model(nn.Module):
    def __init__(self):
        ...
        archive = zipfile.ZipFile('model/iaes_small_relu_f32.pnnx.bin', 'r')
...
def export_torchscript():
    ...
    mod.save("model/iaes_small_relu_f32_pnnx.py.pt")
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "model/iaes_small_relu_f32_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "model/iaes_small_relu_f32_pnnx.py.pt", v_0)
