...
def train_and_export_nsl(train_csv, test_csv):
    ...
    print("Aplicando normalizacao Min-Max com Clip de Seguranca...")
    for col in feature_cols:
        ...
        # O clipe garante que os valores do Teste jamais ultrapassem [0, 1]
    ...
    print("Exportando modelo via PNNX...")
    traced_model = torch.jit.trace(model, dummy_input)
    traced_model.save("model/nsl_model.pt")
    os.system(f"pnnx model/nsl_model.pt inputshape=[1,{input_dim}]")
