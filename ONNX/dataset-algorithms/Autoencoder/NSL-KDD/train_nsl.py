...
def train_and_export_nsl(train_csv, test_csv):
    ...
    torch.onnx.export(model, dummy_input, "model/nsl_model.onnx", input_names=['input'], output_names=['output'])
    
    onnx_model = onnx.load("model/nsl_model.onnx")
    onnx_model.ir_version = 9
    onnx.save(onnx_model, "model/nsl_model.onnx")
    print("Sucesso!!! Modelo salvo como 'model/nsl_model.onnx'")

if __name__ == "__main__":
    # Caminho baseando-se na pasta que você acabou de enviar
