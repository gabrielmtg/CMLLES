...
def main():
    ...
    train_out = session.run([output_name], {input_name: X_train_normal})[0]
    ...
    test_out = session.run([output_name], {input_name: X_test})[0]
